...
pub static FS_MAX_RETRY: &str = "FS_MAX_RETRY";
pub static FS_DELAY_BEFORE_NEXT_RETRY: &str = "FS_DELAY_BEFORE_NEXT_RETRY";
pub static DELAY_BEFORE_NEXT_RETRY: &str = "DELAY_BEFORE_NEXT_RETRY";
...
pub static INDEX_INTERVAL_WAIT_FOR_TASK: &str = "INDEX_INTERVAL_WAIT_FOR_TASK";
pub static SLEEP_BEFORE_NEXT_VIRTUOSO_QUERY: &str = "SLEEP_BEFORE_NEXT_VIRTUOSO_QUERY";
pub static SLEEP_BEFORE_NEXT_MEILISEARCH_BATCH: &str = "SLEEP_BEFORE_NEXT_MEILISEARCH_BATCH";
pub static SLEEP_BEFORE_NEXT_TASK: &str = "SLEEP_BEFORE_NEXT_TASK";
pub static INDEX_MAX_TOTAL_HITS: &str = "INDEX_MAX_TOTAL_HITS";
pub static INDEX_MAX_RETRY: &str = "INDEX_MAX_RETRY";
pub static INDEX_DELAY_BEFORE_NEXT_RETRY: &str = "INDEX_DELAY_BEFORE_NEXT_RETRY";
