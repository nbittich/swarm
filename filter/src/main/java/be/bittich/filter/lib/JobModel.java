...
public class JobModel {
    ...
    @JsonSubTypes({
            ...
            @JsonSubTypes.Type(value = Payload.Index.class, name = "index"),
    ...
    public sealed interface Payload
            permits Payload.None, Payload.Index, Payload.Archive, Payload.Cleanup, Payload.ScrapeUrl,
        ...
        @Builder(toBuilder = true)
        public record Index() implements Payload {
        }
    ...
    public sealed interface TaskResult
        ...
        public record Publish(@JsonProperty("value") PublishValue value) implements TaskResult {
            ...
            public record PublishValue(
                    ...
                    @JsonProperty("diffManifestFilePath") Path diffManifestFilePath,
