...
export default function MainLayout() {
  ...
  items.push(
    getItem(
      <Link onClick={() => handleNavigation("/search")}>Search</Link>,
      "/search",
      <SearchOutlined />,
    ),
  );
  items.push(
    getItem(
      <Link onClick={() => handleNavigation("/jobs")}>Jobs</Link>,
      "/jobs",
      <ThunderboltOutlined />,
    ),
  );
  items.push(
    getItem(
      <Link onClick={() => handleNavigation("/scheduled-jobs")}>
        Scheduled Jobs
      </Link>,
      "/scheduled-jobs",
      <CalendarOutlined />,
  ...
  items.push(
    getItem(
      <Link onClick={() => handleNavigation("/yasgui")}>SPARQL</Link>,
      "/yasgui",
      <ConsoleSqlOutlined />,
    ),
  );
    ...
    <ConfigProvider
      ...
      theme={{
        ...
        components: {
          Layout: {
            headerBg: darkMode
              ? darkToken.colorBgBlur
              : defaultToken.colorBgBase,
            headerPadding: 0,
          },
          Menu: {
