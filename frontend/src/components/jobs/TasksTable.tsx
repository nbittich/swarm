        ...
        if (record.result) {
          ...
          if (res.type == "publish") {
            return <Flex vertical gap="small">
              <Tag>
                <a onClick={async () => await download(record.jobId, res.value.insertedTripleFilePath)}><DownloadOutlined />inserted.ttl.gz</a></Tag>
              <Tag>
                <a onClick={async () => await download(record.jobId, res.value.removedTripleFilePath)}><DownloadOutlined />removed.ttl.gz</a></Tag>
              <Tag>
                <a onClick={async () => await download(record.jobId, res.value.intersectTripleFilePath)}><DownloadOutlined />intersect.ttl.gz</a></Tag>
              <Tag>
                <a onClick={async () => await download(record.jobId, res.value.failedQueryFilePath)}><DownloadOutlined />failed.sparql.gz</a></Tag>
            </Flex>
